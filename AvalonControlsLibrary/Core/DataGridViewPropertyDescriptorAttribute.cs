...
namespace AC.AvalonControlsLibrary.Core
{
    ...
    {
        private Type collectionNotificationStrategy;

        /// <summary>
        /// Gets or sets the type of strategy to use for displaying the data of the collection
        /// </summary>
        public Type CollectionNotificationStrategy
        {
            get { return collectionNotificationStrategy; }
            set
            {
                if (value.GetInterface(typeof(ICollectionNotificationStrategy).FullName) == null)
                ...
                collectionNotificationStrategy = value;
            }
        }
        ...
        internal DataGridViewColumn GetDataGridViewColumn()
        {
            ...
            if (collectionNotificationStrategy != null)
            {
                converter = CollectionNotificationManager.RegisterCollectionNotification(collectionNotificationStrategy);
                memeberBinding.Converter = converter;
                column.CanSort = false;
            }
