...
namespace AC.AvalonControlsLibrary.Controls
{
    ...
    /// </summary>
    public class DataGridViewColumn : SortableGridViewColumn, IComparable<DataGridViewColumn>
    {
        double lastWidth;
        ...
        #region IComparable<DataGridViewColumn> Members

        /// <summary>
        /// compares the DataGridViewColumn with another
        /// </summary>
        /// <param name="other">The DataGridViewColumn to compare</param>
        /// <returns></returns>
        public int CompareTo(DataGridViewColumn other)
        {
            if (other == null)
                return -1;
            return DefaultPosition.CompareTo(other.DefaultPosition);
        }
